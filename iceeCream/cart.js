...
class Cart {
    ...
    addItem(id) {
        const iceCreamDetails = {
            trinity: { name: 'Trinity', price: 5.99, image: 'images/Trinity.jpg' },
            vanilla: { name: 'Fun Time Vanilla', price: 4.99, image: 'images/funTimeVanilla.jpg' },
            fairy: { name: 'Fairy Pink', price: 6.49, image: 'images/FairyPink.jpg' }
        };
    ...
    showToast(message) {
        ...
        toast.className = 'fixed bottom-4 right-4 bg-pink-600 text-white px-6 py-3 rounded-lg shadow-lg transform transition-transform duration-300';
    ...
    updateOrderStatus(orderId) {
        ...
        const statuses = ['Processing', 'In Progress', 'Ready for Pickup', 'Completed'];
        ...
        order.estimatedTime = remainingMinutes > 0 ? `${remainingMinutes} minutes` : 'Ready now';
...
if (checkStatusBtn) {
    checkStatusBtn.addEventListener('click', () => {
        ...
        document.getElementById('orderTime').textContent = new Date(updatedOrder.timestamp).toLocaleString();
